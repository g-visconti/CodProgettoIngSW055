...
public class ViewRegistrazione extends JFrame {
	...
	public ViewRegistrazione(String Email_Utente) {
		...
		lblNewLabel_1 = new JLabel("Inserire tutti dati correttamente:");
		...
		btnNewButton.setBounds(154, 401, 139, 25);

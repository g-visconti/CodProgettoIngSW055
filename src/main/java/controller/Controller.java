...
public class Controller {
	...
	public void registraNuovoUtente(String email, String password)  { //Registrazione terze parti
	    try {
	...
	public void registraNuovoUtente(String email, String password, String nome, String cognome, String citta, String telefono, String cap, String indirizzo, String ruolo) {
	    try {
	        Connection connAWS = ConnessioneDatabase.getInstance().getConnection();
	        AccountDAO accountDAO = new AccountDAO(connAWS);
	        ClienteDAO clienteDAO = new ClienteDAO(connAWS);

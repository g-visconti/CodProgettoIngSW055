...
/**
 * Finestra per l'inserimento dell'email di lavoro di un nuovo utente.
 * Questa interfaccia permette agli amministratori di inserire l'email
 * di un nuovo agente immobiliare o amministratore di supporto da registrare nel sistema.
 *
 ...
 * </ul>
 *
 * <p>In base al tipo di inserimento selezionato, l'utente viene reindirizzato
 * alla finestra appropriata per completare la registrazione.
 *
...
public class ViewInserimentoEmail extends JFrame {
	...
	/**
	 * Costruttore della finestra di inserimento email.
	 * Inizializza l'interfaccia grafica e configura i componenti per
	 * l'inserimento dell'email di lavoro di un nuovo utente.
	 *
	 * <p>La finestra viene configurata in base al tipo di utente da registrare:
	 * <ul>
	...
	public ViewInserimentoEmail(String agenzia, TipoInserimento tipo) {
		...
		lblErroreEmail.setBounds(165, 125, 300, 22);
	...
	/**
	 * Configura il comportamento di un campo di testo con testo placeholder.
	 * Quando il campo riceve il focus, il testo placeholder viene rimosso.
	 * Quando perde il focus e il campo è vuoto, il testo placeholder viene ripristinato.
	 *
	 * <p>Questo metodo fornisce un'interfaccia utente più intuitiva per i campi di input
	 * che richiedono un testo di esempio per guidare l'utente.
	 *
	 ...
	 * Utilizzata per determinare quale interfaccia di registrazione mostrare
	 * dopo l'inserimento dell'email.
	 *
	 * <p>I valori possibili sono:
	 * <ul>
	 *   <li><b>SUPPORTO</b>: Amministratore di supporto con privilegi limitati</li>
	 *   <li><b>AGENTE</b>: Agente immobiliare con funzionalità di gestione immobili</li>
	 * </ul>
	 *

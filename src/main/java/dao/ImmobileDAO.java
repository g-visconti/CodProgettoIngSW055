...
public class ImmobileDAO {
	...
	// riempie la tabella con immobili in vendita ed affitto che hanno ricevuto
	// un'offerta
	public void riempiTableRisultatiDAO(JTable tableRisultati) {
		String query = " SELECT " + "'Vendita' AS \"Categoria\", " + "i.\"titolo\" AS \"Tipologia\", "
				+ "v.\"prezzoTotale\" AS \"Prezzo (€)\", " + "i.\"idImmobile\" AS \"idOrdine\" "
				+ " FROM \"Immobile\" i JOIN \"ImmobileinVendita\" v " + " ON i.\"idImmobile\" = v.\"idImmobile\" "
				+ " UNION " + " SELECT " + " 'Affitto' AS \"Categoria\", " + " i.\"titolo\" AS \"Tipologia\", "
				+ " a.\"prezzoMensile\" AS \"Prezzo (€)\", " + " i.\"idImmobile\" AS \"idOrdine\" "
				+ " FROM \"Immobile\" i JOIN \"ImmobileinAffitto\" a " + " ON i.\"idImmobile\" = a.\"idImmobile\" "
		...
		try (PreparedStatement stmt = connection.prepareStatement(query)) {
			...
			// Configurazione larghezze colonne - DIMENSIONI PIÙ STRETTE PER CATEGORIA E
			// PREZZO

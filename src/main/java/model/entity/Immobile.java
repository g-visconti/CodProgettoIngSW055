...
public class Immobile {
	...
	public Immobile() {
		// costruttore vuoto necessario per l’ereditarietà e per creare oggetti senza
		// parametri
	}
	...
	public JSONObject getFiltriAsJson() {
		...
		filtriJson.put("riscaldamento", this.climatizzazione); // o "climatizzazione", se preferisci mantenerlo così nel
																// DB

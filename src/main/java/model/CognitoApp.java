...
public class CognitoApp {
    ...
    public static boolean authenticateWithGoogle(String googleAccessToken) {
        ...
        JsonObject jsonRequest = new JsonObject();
        jsonRequest.addProperty("IdentityPoolId", "eu-west-1:710dcdd9-c2f3-4039-baf0-7768cb3d4c02");  // Sostituisci con il tuo Identity Pool ID
        ...
        Request request = new Request.Builder()
            .url("https://cognito-identity.eu-west-1.amazonaws.com/")  // Cognito URL
            .post(body)
            .addHeader("Content-Type", "application/json")
            .build();
